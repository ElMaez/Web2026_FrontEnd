...
var Cat = /** @class */ (function () {
    function Cat(catName, gender, species, color, birthdate) {
...
var myCat1 = new Cat("Whiskers", "Female", "Main Coon", "White");
var myCat2 = new Cat("Burney", "Male", "Sphinx", "Beige");
var myCat3 = new Cat("noget", "Male", "2", "Beige", new Date(2026, 0, 1));
console.log("myCat1", myCat1, "myCat2", myCat2, "myCat3", myCat3);
var cat = { name: "Charlie", gender: "Male", species: "Maine Coon", color: "" };
cat.color = "Brown";
console.log(cat);
//destrukturing
var catName = myCat2.catName, gender = myCat2.gender, species = myCat2.species, color = myCat2.color;
